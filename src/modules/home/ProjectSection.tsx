...
export const ProjectsSection = () => {
    return (
        <section className="home-section" id={HOME_PAGE_ANCHORS.projects}>
            ...
            <FeatureProjectsPane featuredProjects={homeCopy.projects.projectsArr.filter((project) => project.isFeatured)} />
            <h2>{homeCopy.projects.normalProjectsTitle}</h2>
            <ProjectPane projects={homeCopy.projects.projectsArr.filter(project => !project.isFeatured)} />
        </section>
    )
}